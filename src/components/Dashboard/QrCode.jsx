        ...
        <>
            ...
            <div className='flex'>
                ...
                <div className='flex flex-col space-y-4  w-2/4 mx-auto pt-20 '>
                    <div className='flex'><p className='text-3xl font-bold'>Qr Codes</p></div>
                    <div className='w-full p-6 border-1  shadow-sm shadow-cyan-500/50 ... flex rounded-2xl'>
                        <div className='w-36 h-36 flex items-center justify-center'><img src="/logo.png" alt="" /></div>
                        ...
                        <div className=' w-1/4 flex gap-2 justify-end'>
                            ...
                            <button className='h-10 text-sm'><i className='fa-solid fa-download'></i></button>
                        </div>
                    </div>
                    <div >
